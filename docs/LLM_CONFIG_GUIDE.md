...
先看 [LLM 服务商配置速查](./llm-providers.md) 了解官方来源、Channel 口径、模型示例和 GitHub Actions 的 secrets/variables 分工，再按你的使用能力选择本页配置方式会更快避免踩坑。
...
6. **【先看服务商速查】** 想确认某厂商 Base URL/模型边界 -> [指路 docs/llm-providers.md](./llm-providers.md)
