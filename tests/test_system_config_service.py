...
class SystemConfigServiceTestCase(unittest.TestCase):
    ...
    def test_test_llm_channel_adds_focused_diagnostic_reasons(self, mock_completion) -> None:
        ...
        cases = [
            ...
            (Exception("model gpt-4o is not authorized for this account"), "model_access_denied", "model_access_denied"),
            (
                Exception("litellm.APIError: APIError: OpenAIException - Model disabled."),
                "model_access_denied",
                "model_access_denied",
            ),
            (Exception("Model is disabled for this account"), "model_access_denied", "model_access_denied"),
